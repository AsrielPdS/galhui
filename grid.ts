...
import { $, C, Size,icon,Icon, logo } from "./galhui";
import { bind, L } from "orray";
import { crudHandler, ICrud, kbHandler, kbHTp } from "./list";
...
export class Grid<T extends Node> extends E<IGrid<T>>{
  ...
  view() {
    ...
    return bind(dt, this.bind(d, () => d.uncls().cls(cl("_", i.sz, "grid")), "sz"), {
      insert: (v) => div(C.item, [
